            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="col-span-1 mx-5">
                    ...
                    <div className="flex items-center justify-between">
                        <Link href="/cart" className="flex items-center gap-2"><FaArrowLeftLong /> Back to Cart</Link>
                        <button className="btn btn-primary text-white flex items-center justify-center"><MdDone /> Confirm Order</button>
                    </div>
                </div>
            </div>
        </div>
